...
public final class CoreBridgeFactory {
    ...
    private static final String CORE_BRIDGE_CLASS = "com.zpkdxgames.plexonbackpacks.integration.core.PlexonCoreBridge";
    ...
    public static CoreBridge resolve(JavaPlugin plugin) {
        ...
        if (corePlugin == null) {
            plugin.getLogger().info("PlexonCore not installed; starting PlexonBackpacks in standalone compatibility mode.");
